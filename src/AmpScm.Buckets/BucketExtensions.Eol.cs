...
#endif
        public static async ValueTask<(BucketBytes, BucketEol)> ReadExactlyUntilEolAsync(this Bucket bucket, BucketEol acceptableEols, int requested = Bucket.MaxRead, BucketEolState? eolState = null)
        {
            if (bucket is null)
